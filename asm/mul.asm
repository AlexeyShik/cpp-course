...
.loop:
                ...
                call            mul_long_short
                pop             rdi
                ; умножили на qword - аналог *10 в десятичной
                mov             rbx, [rdi]
                lea             rdi, [rdi - 8]
                ; взяли текущий qword числа и терешли к следующему
                push            rdi
                mov             rdi, r10
                call            set_zero
                ; почистили r10 от прошлого слагаемого
                mov             rcx, 128
                call            add_long_long
                mov             rcx, 256
                ; перекопировали длинное число в r10, чтобы не испортить его в rsi
                call            mul_long_short
                mov             r10, rdi
                ...
                pop             rsi
                pop             rdi
                ; прибавили к ответу новое слагаемое
                dec             r8
                jnz             .loop
